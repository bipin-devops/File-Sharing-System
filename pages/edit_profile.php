...
<!-- banner -->
  ...
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   ...
	   <div class="container">
		 <form class="contact_form" action='<?php $_SERVER["PHP_SELF"];?>' method='post'   enctype='multipart/form-data'>
			...
			<div class="col-md-6 grid_6">
				...
				<input style="float:left; margin-top:1%;" type="file"> 
...
if($error=="" && $error1==""  ) {
		...
		$sql = " update tbl_user set fname='$fname', lname='$lname', address='$address', contact='$phone', images='$images' where id='$id' "; 	
					 } 
					 else { 
