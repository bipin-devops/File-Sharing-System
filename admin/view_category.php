...
<div id="page-heading"><h1>View Category</h1></div>
	...
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
				...
				<tr>
					...
					<?php echo"<a href='delete_category.php?id=$row[id]' title='Delete' class='icon-2 info-tooltip'onclick='return ConfirmDelete()'> </a>";?>
