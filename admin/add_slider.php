...
if($error=="" && $nameerror==""  ) {
				...
				$sql="Insert into tbl_slider(`testimonial`,`author`,`date`,`images`) 
					values('$testimonial','$author','$date','$images')";
			...
			{ 
									...
									<!-- start message-green -->
											...
											<table border="0" width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<td class="green-left">Slider Added sucessfully <a href="add_slider.php">Add Next one.</a></td>
									...
									?>
												...
												<table border="0" width="100%" cellpadding="0" cellspacing="0">
												<tr>
													<td class="red-left">Error. <a href="add_slider.php">Please try again.</a></td>
