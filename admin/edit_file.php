				    ...
				    $error.="Please fill all the required fields. <br> ";	
				     ...
				     // check if name only contains letters and whitespace
						     if (!preg_match("/^[a-zA-Z ]*$/",$file_name)) {
					    	  ...
					    	  if($_FILES["files"]["type"] == "file/ppt" || $_FILES["files"]["type"] == "file/pdf" || $_FILES["files"]["type"] == "file/docx" )
						     	 {	
									$fileerror1.= "";
								 }
							 else{
...
if($error=="" && $nameerror=="" && $imgerror1=="" && $imgerror2=="" && $fileerror1=="" && $fileerror2=="" ) {
					...
					$sql = " update tbl_file set cat_id='$cat', file_name ='$file_name', description ='$description', upload_date='$upload_date',files='$files' where id='$id' ";
					}
				...
				$images="";
					...
					if(is_uploaded_file($_FILES["images"]['tmp_name'])) {
						...
						$sql = " update tbl_file set cat_id='$cat', file_name ='$file_name', description ='$description', upload_date='$upload_date',images='$images' where id='$id' ";
					 } 
					 else { 
					 	$sql = " update tbl_file set cat_id='$cat', file_name ='$file_name', description ='$description', upload_date='$upload_date' where id='$id' ";; 
					 }
	...
	?>
		...
		<form action='<?php $_SERVER["PHP_SELF"];?>' method='post' enctype='multipart/form-data'>
										...
										<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
											...
											<tr>
											<th>Files :</th>
											<td>  <input type="file" name = "files"  />&nbsp;&nbsp;  <span class="error">* <?php echo $error; echo $fileerror1; echo $fileerror2; ?></span></td>
											</tr>
										<tr>
											<th>Image :</th>
